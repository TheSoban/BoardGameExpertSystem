...
public class BoardGame implements ActionListener {
    ...
    BoardGame() {
        ...
        try {
            this.autoResources = ResourceBundle.getBundle("resources.GameResources", Locale.getDefault());
        ...
        JFrame frame = new JFrame(autoResources.getString("ProjectName"));
